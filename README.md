...
- One-command deployment of a loopback-only evaluation-log Monitor with platform configuration, synchronization, task and sample analysis, multi-output switching, filtered logs, and run comparison.
